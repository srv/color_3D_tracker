...
/** \brief Trainer constructor
  * \param transport
  */
color_circle_tracker::Trainer::Trainer(const std::string transport) : StereoImageProcessor(transport)
{
  ...
  ROS_INFO_STREAM("[Trainer:] color_circle Trainer Settings:" << std::endl <<
  ...
  cv::setMouseCallback("Training GUI", &color_circle_tracker::Trainer::staticMouseCallback, this);
}

color_circle_tracker::Trainer::~Trainer()
{
...
/** \brief Stereo Image Callback
  ...
  */
void color_circle_tracker::Trainer::stereoImageCallback(
...
/** \brief Detect the color_circle into the image
  ...
  */
cv::MatND color_circle_tracker::Trainer::train(const cv::Mat& image)
{
  ...
  cv::namedWindow("color_circle-HS-histogram", 0);
  cv::namedWindow("color_circle-HV-histogram", 0);
...
/** \brief static function version of mouseCallback
  ...
  */
void color_circle_tracker::Trainer::staticMouseCallback(int event, int x, int y, int flags, void* param)
{
...
/** \brief Mouse callback for training
  ...
  * \param input params. Need to be correctly re-caster to work
  */
void color_circle_tracker::Trainer::mouseCallback( int event, int x, int y, int flags, void* param)
{
...
/** \brief Histogram calculation in HSV colorspace
  ...
  */
cv::MatND color_circle_tracker::Trainer::calculateHistogram(const cv::Mat& image, 
                                                          const int bins[],  
                                                          const cv::Mat& mask)
{   
...
/** \brief Histogram plot in OpenCV namedWindow
  ...
  */
void color_circle_tracker::Trainer::showHSVHistogram(const cv::MatND& histogram,
